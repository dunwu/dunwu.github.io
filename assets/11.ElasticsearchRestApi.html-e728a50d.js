import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c as p,a as s,b as n,d as e,e as t}from"./app-ee97b13a.js";const c={},u=s("h1",{id:"elasticsearch-rest-api",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#elasticsearch-rest-api","aria-hidden":"true"},"#"),n(" ElasticSearch Rest API")],-1),r={href:"https://github.com/elastic/elasticsearch",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/elastic/elasticsearch",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/apache/lucene-solr",target:"_blank",rel:"noopener noreferrer"},m=s("p",null,[s("em",null,"以下简称 ES"),n("。")],-1),k={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/rest-apis.html",target:"_blank",rel:"noopener noreferrer"},b=t(`<h2 id="elasticsearch-rest-api-语法格式" tabindex="-1"><a class="header-anchor" href="#elasticsearch-rest-api-语法格式" aria-hidden="true">#</a> ElasticSearch Rest API 语法格式</h2><p>向 Elasticsearch 发出的请求的组成部分与其它普通的 HTTP 请求是一样的：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> -X<span class="token operator">&lt;</span>VERB<span class="token operator">&gt;</span> <span class="token string">&#39;&lt;PROTOCOL&gt;://&lt;HOST&gt;:&lt;PORT&gt;/&lt;PATH&gt;?&lt;QUERY_STRING&gt;&#39;</span> <span class="token parameter variable">-d</span> <span class="token string">&#39;&lt;BODY&gt;&#39;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><code>VERB</code>：HTTP 方法，支持：<code>GET</code>, <code>POST</code>, <code>PUT</code>, <code>HEAD</code>, <code>DELETE</code></li><li><code>PROTOCOL</code>：http 或者 https 协议（只有在 Elasticsearch 前面有 https 代理的时候可用）</li><li><code>HOST</code>：Elasticsearch 集群中的任何一个节点的主机名，如果是在本地的节点，那么就叫 localhost</li><li><code>PORT</code>：Elasticsearch HTTP 服务所在的端口，默认为 9200 PATH API 路径（例如_count 将返回集群中文档的数量），</li><li><code>PATH</code>：可以包含多个组件，例如 <code>_cluster/stats</code> 或者 <code>_nodes/stats/jvm</code></li><li><code>QUERY_STRING</code>：一些可选的查询请求参数，例如?pretty 参数将使请求返回更加美观易读的 JSON 数据</li><li><code>BODY</code>：一个 JSON 格式的请求主体（如果请求需要的话）</li></ul><p>ElasticSearch Rest API 分为两种：</p><ul><li><strong>URI Search</strong>：在 URL 中使用查询参数</li><li><strong>Request Body Search</strong>：基于 JSON 格式的、更加完备的 DSL</li></ul><p>URI Search 示例：</p><figure><img src="https://raw.githubusercontent.com/dunwu/images/dev/snap/20220530072511.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>Request Body Search 示例：</p><figure><img src="https://raw.githubusercontent.com/dunwu/images/dev/snap/20220530072654.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="索引-api" tabindex="-1"><a class="header-anchor" href="#索引-api" aria-hidden="true">#</a> 索引 API</h2>`,11),q={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-indices.html",target:"_blank",rel:"noopener noreferrer"},g=t(`<h3 id="创建索引" tabindex="-1"><a class="header-anchor" href="#创建索引" aria-hidden="true">#</a> 创建索引</h3><p>新建 Index，可以直接向 ES 服务器发出 <code>PUT</code> 请求。</p><p>语法格式：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>PUT /my_index
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>需要注意的是，如果别名与索引是一对一的，使用别名索引文档或者查询文档是可以的，但是如果别名和索引是一对多的，使用别名会发生错误，因为 ES 不知道把文档写入哪个索引中去或者从哪个索引中读取文档。</p></blockquote>`,27),h={href:"https://www.knowledgedict.com/tutorial/elasticsearch-index-smooth-shift.html",target:"_blank",rel:"noopener noreferrer"},_=t(`<h3 id="打开-关闭索引" tabindex="-1"><a class="header-anchor" href="#打开-关闭索引" aria-hidden="true">#</a> 打开/关闭索引</h3><p>通过在 <code>POST</code> 中添加 <code>_close</code> 或 <code>_open</code> 可以打开、关闭索引。</p><p>打开索引</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 打开索引</span>
POST kibana_sample_data_ecommerce/_open
<span class="token comment"># 关闭索引</span>
POST kibana_sample_data_ecommerce/_close
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文档" tabindex="-1"><a class="header-anchor" href="#文档" aria-hidden="true">#</a> 文档</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">############Create Document############</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，返回结果的 <code>took</code>字段表示该操作的耗时（单位为毫秒），<code>timed_out</code>字段表示是否超时，<code>hits</code>字段表示命中的记录，里面子字段的含义如下。</p><ul><li><code>total</code>：返回记录数，本例是 2 条。</li><li><code>max_score</code>：最高的匹配程度，本例是<code>1.0</code>。</li><li><code>hits</code>：返回的记录组成的数组。</li></ul><p>返回的记录中，每条记录都有一个<code>_score</code>字段，表示匹配的程序，默认是按照这个字段降序排列。</p><h3 id="全文搜索" tabindex="-1"><a class="header-anchor" href="#全文搜索" aria-hidden="true">#</a> 全文搜索</h3>`,52),f={href:"https://www.elastic.co/guide/en/elasticsearch/reference/5.5/query-dsl.html",target:"_blank",rel:"noopener noreferrer"},x=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">curl</span> <span class="token parameter variable">-H</span> <span class="token string">&#39;Content-Type: application/json&#39;</span> <span class="token string">&#39;localhost:9200/user/admin/_search?pretty&#39;</span>  <span class="token parameter variable">-d</span> <span class="token string">&#39;
{
&quot;query&quot; : { &quot;match&quot; : { &quot;desc&quot; : &quot;管理&quot; }}
}&#39;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),y={href:"https://www.elastic.co/guide/en/elasticsearch/reference/5.5/query-dsl-match-query.html",target:"_blank",rel:"noopener noreferrer"},E=s("code",null,"desc",-1),T=t(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码搜索的是<code>软件 or 系统</code>。</p>`,8),G=s("code",null,"and",-1),P={href:"https://www.elastic.co/guide/en/elasticsearch/reference/5.5/query-dsl-bool-query.html",target:"_blank",rel:"noopener noreferrer"},S=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">curl</span> <span class="token parameter variable">-H</span> <span class="token string">&#39;Content-Type: application/json&#39;</span> <span class="token string">&#39;localhost:9200/user/admin/_search?pretty&#39;</span>  <span class="token parameter variable">-d</span> <span class="token string">&#39;
{
 &quot;query&quot;: {
  &quot;bool&quot;: {
   &quot;must&quot;: [
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="节点-api" tabindex="-1"><a class="header-anchor" href="#节点-api" aria-hidden="true">#</a> 节点 API</h2>`,10),O={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-nodes.html",target:"_blank",rel:"noopener noreferrer"},A=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看默认的字段</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="分片-api" tabindex="-1"><a class="header-anchor" href="#分片-api" aria-hidden="true">#</a> 分片 API</h2>`,2),D={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-shards.html",target:"_blank",rel:"noopener noreferrer"},R=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看默认的字段</span>
GET /_cat/shards
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="监控-api" tabindex="-1"><a class="header-anchor" href="#监控-api" aria-hidden="true">#</a> 监控 API</h2><p>Elasticsearch 中集群相关的健康、统计等相关的信息都是围绕着 <code>cat</code> API 进行的。</p><p>通过 GET 请求发送 cat，下面列出了所有可用的 API：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>GET /_cat
...
/_cat/templates
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,6),B=s("strong",null,"官方",-1),U={href:"https://www.elastic.co/cn/products/elasticsearch",target:"_blank",rel:"noopener noreferrer"},L={href:"https://github.com/elastic/elasticsearch",target:"_blank",rel:"noopener noreferrer"},N={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html",target:"_blank",rel:"noopener noreferrer"};function j(z,M){const a=l("ExternalLinkIcon");return o(),p("div",null,[u,s("blockquote",null,[s("p",null,[s("strong",null,[s("a",r,[n("Elasticsearch"),e(a)]),n(" 是一个分布式、RESTful 风格的搜索和数据分析引擎")]),n("，能够解决不断涌现出的各种用例。 作为 Elastic Stack 的核心，它集中存储您的数据，帮助您发现意料之中以及意料之外的情况。")]),s("p",null,[s("a",d,[n("Elasticsearch"),e(a)]),n(" 基于搜索库 "),s("a",v,[n("Lucene"),e(a)]),n(" 开发。ElasticSearch 隐藏了 Lucene 的复杂性，提供了简单易用的 REST API / Java API 接口（另外还有其他语言的 API 接口）。")]),m,s("p",null,[n("REST API 最详尽的文档应该参考："),s("a",k,[n("ES 官方 REST API"),e(a)])])]),b,s("blockquote",null,[s("p",null,[n("参考资料："),s("a",q,[n("Elasticsearch 官方之 cat 索引 API"),e(a)])])]),g,s("p",null,[n("ES 索引别名有个典型的应用场景是平滑切换，更多细节可以查看 "),s("a",h,[n("Elasticsearch（ES）索引零停机（无需重启）无缝平滑切换的方法"),e(a)]),n("。")]),_,s("p",null,[n("ES 的查询非常特别，使用自己的"),s("a",f,[n("查询语法"),e(a)]),n("，要求 GET 请求带有数据体。")]),x,s("p",null,[n("上面代码使用 "),s("a",y,[n("Match 查询"),e(a)]),n("，指定的匹配条件是"),E,n('字段里面包含"软件"这个词。返回结果如下。')]),T,s("p",null,[n("如果要执行多个关键词的"),G,n("搜索，必须使用"),s("a",P,[n("布尔查询"),e(a)]),n("。")]),S,s("blockquote",null,[s("p",null,[s("a",I,[n("Elasticsearch 官方之 Cluster API"),e(a)])])]),w,s("blockquote",null,[s("p",null,[s("a",O,[n("Elasticsearch 官方之 cat Nodes API"),e(a)]),n("——返回有关集群节点的信息。")])]),A,s("blockquote",null,[s("p",null,[s("a",D,[n("Elasticsearch 官方之 cat Shards API"),e(a)]),n("——shards 命令是哪些节点包含哪些分片的详细视图。它会告诉你它是主还是副本、文档数量、它在磁盘上占用的字节数以及它所在的节点。")])]),R,s("ul",null,[s("li",null,[B,s("ul",null,[s("li",null,[s("a",U,[n("Elasticsearch 官网"),e(a)])]),s("li",null,[s("a",L,[n("Elasticsearch Github"),e(a)])]),s("li",null,[s("a",N,[n("Elasticsearch 官方文档"),e(a)])])])])])])}const J=i(c,[["render",j],["__file","11.ElasticsearchRestApi.html.vue"]]);export{J as default};
