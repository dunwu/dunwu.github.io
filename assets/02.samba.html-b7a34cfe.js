...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>输入 samba 用户的密码，如果成功，就会进入 <code>smb: \\&gt;</code>。</p><h3 id="访问-samba-服务共享的目录" tabindex="-1"><a class="header-anchor" href="#访问-samba-服务共享的目录" aria-hidden="true">#</a> 访问 samba 服务共享的目录</h3><p>Windows：</p><p>访问：<code>\\\\&lt;你的ip&gt;\\&lt;你的共享路径&gt;</code> ：</p><figure><img src="https://raw.githubusercontent.com/dunwu/images/dev/snap/20180920180928161334.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>Mac：</p><p>与 Windows 类似，直接在 Finder 中访问 <code>smb://&lt;你的ip&gt;/&lt;你的共享路径&gt;</code> 即可。</p><h2 id="配置详解" tabindex="-1"><a class="header-anchor" href="#配置详解" aria-hidden="true">#</a> 配置详解</h2><h3 id="samba-默认配置" tabindex="-1"><a class="header-anchor" href="#samba-默认配置" aria-hidden="true">#</a> samba 默认配置</h3>`,41),u={href:"https://git.samba.org/samba.git/?p=samba.git;a=blob_plain;f=examples/smb.conf.default;hb=HEAD",target:"_blank",rel:"noopener noreferrer"},d=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ cp /etc/samba/smb.conf /etc/samba/smb.conf.bak
