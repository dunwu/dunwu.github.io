...
- [1. Git 简介](#1-git-简介)
  - [1.1. Git 是什么](#11-git-是什么)
  - [1.2. 什么是版本控制](#12-什么是版本控制)
  - [1.3. 为什么使用 Git](#13-为什么使用-git)
  - [1.4. Git 的工作原理](#14-git-的工作原理)
- [2. 分支管理](#2-分支管理)
  - [2.1. Git Flow](#21-git-flow)
  - [2.2. Github Flow](#22-github-flow)
- [3. Git Commit 规范](#3-git-commit-规范)
  - [3.1. Commit message 的作用](#31-commit-message-的作用)
  - [3.2. Commit message 的规范](#32-commit-message-的规范)
  - [3.3. Git Commit Template](#33-git-commit-template)
  - [3.4. 生成 Change log](#34-生成-change-log)
- [4. Git 奇技淫巧](#4-git-奇技淫巧)
  - [4.1. 生成 SSH 公钥](#41-生成-ssh-公钥)
  - [4.2. 使用 .gitignore 忽略不必提交内容](#42-使用-gitignore-忽略不必提交内容)
  - [4.3. 使用 .gitattributes 解决 LF 和 CRLF 问题](#43-使用-gitattributes-解决-lf-和-crlf-问题)
  - [4.4. 同时提交代码到不同的远程仓库](#44-同时提交代码到不同的远程仓库)
  - [4.5. Github Issue 和 Gitlab Issue](#45-github-issue-和-gitlab-issue)
  - [4.6. Git Hook](#46-git-hook)
- [5. 参考资料](#5-参考资料)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419093855.png)
...
> ![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419110634.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419113532.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419114042.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210420194518.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210420152215.png)

再来一张较好的 Commit message 范例，每次提交的是什么内容，做了什么一目了然。

![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210420151352.png)

### 3.1. Commit message 的作用
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419145223.png)

第二步，提交代码时，按照模板填写 commit message

![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210419145327.png)
...
### 4.3. 使用 .gitattributes 解决 LF 和 CRLF 问题
...
### 4.5. Github Issue 和 Gitlab Issue
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210420114644.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210420141838.png)
